...
// func cmdAddNodes(p *nwmodel.Player, gm *nwmodel.GameModel, args []string) nwmessage.Message {
// 	var nodeCount int
// 	if len(args) != 2 {
...
// func cmdAddString(p *nwmodel.Player, gm *nwmodel.GameModel, args []string) nwmessage.Message {
// 	var nodeCount int
// 	if len(args) == 0 {
...
// func cmdAddPoes(p *nwmodel.Player, gm *nwmodel.GameModel, args []string) nwmessage.Message {
...
// func cmdBakeMap(p *nwmodel.Player, gm *nwmodel.GameModel, args []string) nwmessage.Message {
// 	gm.Map.initAllNodes()
...
// func cmdRemoveNodes(p *nwmodel.Player, gm *nwmodel.GameModel, args []string) nwmessage.Message {
// 	if len(args) == 0 {
...
// func cmdLinkNodes(p *nwmodel.Player, gm *nwmodel.GameModel, args []string) nwmessage.Message {
// 	if len(args) != 2 {
...
// func cmdNewBlankMap(p *nwmodel.Player, gm *nwmodel.GameModel, args []string) nwmessage.Message {
// 	if gm.running {
...
// func cmdNewRandMap(p *nwmodel.Player, gm *nwmodel.GameModel, args []string) nwmessage.Message {
